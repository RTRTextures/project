...
bool SolarSystemExtRenderer::InitSolarSystem()
{
    ...
    data.texture_file = "res/schaudhary/textures/planets/sun.jpg";
    ...
    data.texture_file = "res/schaudhary/textures/planets/mercury.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    data.mipmap = true;
    ...
    data.texture_file = "res/schaudhary/textures/planets/venus.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    data.mipmap = true;
    ...
    data.texture_file = "res/schaudhary/textures/planets/earth.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    data.mipmap = true;
    ...
    data.texture_file = "res/schaudhary/textures/moons/earth/moon.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    ...
    data.texture_file = "res/schaudhary/textures/planets/mars.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    data.mipmap = true;
    ...
    data.texture_file = "res/schaudhary/textures/planets/jupiter.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    data.mipmap = true;
    ...
    data.texture_file = "res/schaudhary/textures/moons/jupiter/europa.png";
    data.textureUnit = GL_TEXTURE0 + (count++);
    ...
    data.texture_file = "res/schaudhary/textures/moons/jupiter/Callisto.png";
    data.textureUnit = GL_TEXTURE0 + (count++);
    ...
    data.texture_file = "res/schaudhary/textures/moons/jupiter/ganymede.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    ...
    data.texture_file = "res/schaudhary/textures/moons/jupiter/io.png";
    data.textureUnit = GL_TEXTURE0 + (count++);
    ...
    data.texture_file = "res/schaudhary/textures/planets/saturn.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    data.mipmap = true;
    ...
    data.texture_file = "res/schaudhary/textures/planets/uranus.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    data.mipmap = true;
    ...
    data.texture_file = "res/schaudhary/textures/planets/neptune.jpg";
    data.textureUnit = GL_TEXTURE0 + (count++);
    data.mipmap = true;
...
RendererResult SolarSystemExtRenderer::Initialize(Window window)
{
    ...
    if (!programPlanet.Initialize("res/schaudhary/Shaders/vPlanet.glsl",
        "res/schaudhary/Shaders/fPlanet.glsl",
        "",
        "",
        "",
        msg)) {
    ...
    if (!programEarth.Initialize("res/schaudhary/Shaders/vEarth.glsl",
        "res/schaudhary/Shaders/fEarth.glsl",
        "",
        "",
        "",
        msg)) {
    ...
    if (!programSun.Initialize("res/schaudhary/Shaders/vSun.glsl",
        "res/schaudhary/Shaders/fSun.glsl",
        "",
        "",
        "",
        msg)) {
